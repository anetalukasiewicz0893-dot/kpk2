...
import { Shield, Globe, MapPin, Calendar, ExternalLink, AlertTriangle, CheckCircle2 } from 'lucide-react';
    ...
    >
      <div className="p-5">
            ...
            <div className="space-y-2 font-mono text-[10px]">
              <div className="flex justify-between items-center">
                ...
                <span className={`px-1.5 py-0.5 rounded ${
                  entity.status === 'ISSUED' ? 'bg-emerald-50 text-emerald-600' : 'bg-rose-50 text-rose-600'
                }`}>{entity.status}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-neutral-400">Category</span>
                <span className="text-neutral-700">{entity.entity_category}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-neutral-400">Authority</span>
                <span className="text-neutral-700">{entity.registration_authority}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2 pt-4 border-t border-neutral-100">
          <span className="text-[10px] font-bold text-neutral-400 uppercase mr-2">Registry Search:</span>
